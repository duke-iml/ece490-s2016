...
class binSelect:
    ...
    def __init__(self):
        ...
        self.bin_dict[1]=[[],0,0,0];
        self.bin_dict[2]=[[],0,0,0];
        self.bin_dict[3]=[[],0,0,0];
        self.bin_dict[4]=[[],0,0,0];
        self.bin_dict[5]=[[],0,0,0]; 
        self.bin_dict[6]=[[],0,0,0];
        self.bin_dict[7]=[[],0,0,0]; 
        self.bin_dict[8]=[[],0,0,0];
        self.bin_dict[9]=[[],0,0,0]; 
        self.bin_dict[10]=[[],0,0,0];
        self.bin_dict[11]=[[],0,0,0]; 
        self.bin_dict[12]=[[],0,0,0];
    ...
    def addtoBin(self,itemid,itembin,itemvol):
        ...
        binlist[3]=binlist[2]*100/self.maxbinvolume; #recalculate percentage full
