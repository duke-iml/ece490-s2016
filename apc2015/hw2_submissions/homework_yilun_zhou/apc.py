...
#shelf object.  
bin_bounds = { # relative to shelf_xform in knowledge base, find the coordinate in world coordinate
...
class ItemGrasp:
    ...
    def __init__(self,xform = se3.identity()):
        ...
        #local coordinates
        self.grasp_xform = xform # gripper to object
...
class ItemInBin:
    ...
    def __init__(self,info,bin_name):
        ...
        self.xform = None # local to world
