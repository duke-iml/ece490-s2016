    ...
    Eigen::Matrix4f & transform )
{
	...
	Eigen::Matrix4f transform1, curr_transform, transform2; 
	pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud_out(new pcl::PointCloud<pcl::PointXYZRGB>);
	pcl::PointCloud<pcl::PointXYZRGB>::Ptr t_cloud(new pcl::PointCloud<pcl::PointXYZRGB>);
	pcl::PointCloud<pcl::PointXYZRGB>::Ptr t_cloud2(new pcl::PointCloud<pcl::PointXYZRGB>);
	...
	*t_cloud = *model; 
	...
	for( int i=1; i<=delta; i++ )
	{
		...
		transformCloud(M_PI/delta*i, 'x', 0, 0, 0, model, transformed_cloud);
                ...
                tmp = Eigen::AngleAxisf (M_PI/delta*i, Eigen::Vector3f::UnitX());
                curr_transform << tmp(0,0),tmp(0,1),tmp(0,2), 0,
   ...
   // pcl::io::savePCDFileASCII ("/home/motion/ece590-s2015/perception/single_utils/src/t_scene1.pcd", *cloud_out);
    ...
    //Eigen::Matrix3f rotation_icp; 
    
    transform = transform1.inverse()*transform2;
    
   // cout<<"ICP transform: "<<transform1<<endl;
   // cout<<"Model transform: "<<transform2<<endl;
...
void selectInitialPose( const pcl::PointCloud<pcl::PointXYZRGB>::Ptr model, const pcl::PointCloud<pcl::PointXYZRGB>::Ptr scene, Eigen::Matrix4f &transform )
{
   ...
   //  pcl::io::savePCDFileASCII ("/home/motion/ece590-s2015/perception/single_utils/src/transformed_model.pcd", *transformed_model);
     ...
     double translate_z = min_scene.z - min_t_model.z + 0.05;
   ...
   //  pcl::io::savePCDFileASCII ("/home/motion/ece590-s2015/perception/single_utils/src/transformed_model1.pcd", *transformed_model);
     ...
     *model = *transformed_model;
     ...
     transform << rotation(0,0), rotation(0,1), rotation (0,2), 0,
                  rotation(1,0), rotation(1,1), rotation (1,2), 0,
                  rotation(2,0), rotation(2,1), rotation (2,2),translate_z,
                  0, 0, 0, 1;
     
     //cout<< "Inverse: " <<pcl::getInverse(transform)<<endl;
...
int main(int argc, char *argv[])
{
    ...
    selectInitialPose(cloud_in, cloudRS, transform_i);
    
    
    
    //cout<<pcl::getInverse(transform_i);
    ...
    // std::cout << transform*transform_i << "\n";
    ...
    final_transform.open ("/home/motion/ece590-s2015/perception/single_utils/xfrom_matrix.txt"); 
    final_transform << transform*transform_i;
