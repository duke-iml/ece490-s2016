...
Q_SCAN_BIN = [1.3901700874328615, -0.5376602655395508, -0.25080585853271486, 0.6726505747192383, 0.2439029449951172, 1.2375389992126467, -0.12962137642822266]
...
ELBOW_UP_BOUNDS = [[-10, 10], [-10, 10], [-10, 10], [-10, 10], [-10, 10], [-10, 10], [-10, 10]]
...
VACUUM_POINT_XFORM = (so3.identity(), [.10, 0.0, .38])
