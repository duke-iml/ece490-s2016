...
class PhysicalLowLevelController(LowLevelController):
    ...
    def __init__(self,robotModel,klampt_model="baxter_with_parallel_gripper_col.rob"):
...
class MyGLViewer(GLRealtimeProgram):
    ...
    def __init__(self,simworld,planworld):
        ...
        if FAKE_SIMULATION:
            ...
            self.low_level_controller = PhysicalLowLevelController(simworld.robot(0),self.sim.controller(0))
