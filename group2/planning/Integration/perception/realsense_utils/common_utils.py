...
def render_3d_scatter(points, proportion=1, xlabel="x", ylabel="y", zlabel="z", return_fig=False):
    '''
    ...
    '''
    if len(points[0])==4:
        ret = render_3d_scatter_with_rgb(points, proportion, xlabel, ylabel, zlabel, return_fig)
        return ret
...
def render_3d_scatter_with_rgb(points, proportion=1, xlabel="x", ylabel="y", zlabel="z", return_fig=False):
    '''
